  ...
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-[#2f343a]/70 bg-[#0f1113]/85 shadow-md">
      <div className="h-1 w-full bg-white/10">
        <div
          className="h-full bg-[#4fd12f] transition-[width] duration-300 ease-out"
      ...
      <div className="p-6 sm:p-8">
        <div className="mb-4 flex items-center gap-2">
          <span
            ...
            className="flex h-6 w-6 items-center justify-center rounded-md bg-[#4fd12f] text-xs font-black text-black"
          >
            {index + 1}
          </span>
          <span className="text-[10px] font-black uppercase tracking-[0.18em] text-white/40 sm:text-xs">
            Fråga {index + 1} av {QUIZ_QUESTIONS.length}
          </span>
        </div>

        <h2 className="text-balance text-lg font-extrabold leading-snug text-white sm:text-2xl">
          {question.title}
          <span aria-label="Den här frågan är obligatorisk." className="ml-1 text-[#4fd12f]">
            *
          </span>
        </h2>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  'focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4fd12f]',
                  isChosen
                    ? 'border-[#4fd12f] bg-[#1e2a12]/85 shadow-[0_0_20px_rgba(79,209,47,0.2)]'
